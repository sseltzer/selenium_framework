...
import com.ctm.selenium.framework.file.disk.DiskManager;
import com.ctm.selenium.framework.file.disk.TimestampedPackage;
...
public abstract class Browser {
	...
	private Predicate<String> equalsString(final String expected) {
		return new Predicate<String>() {
			@Override public boolean apply(String found) { return found.equals(expected); }
		};
	}
	...
	private Predicate<String> containsString(final String expected) { 
		return new Predicate<String>() {
			@Override public boolean apply(String found) { return found.contains(expected); }
		};
	}
	...
	private Predicate<String> matchesRegexString(final String expected) {
		return new Predicate<String>() {
			@Override public boolean apply(String found) { return found.matches(expected); }
		};
	}
	...
	private Function<String, String> switchWindowAndGetTitle = new Function<String, String>() {
		@Override public String apply(String handle) {
