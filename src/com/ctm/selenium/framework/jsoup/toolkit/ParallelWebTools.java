...
package com.ctm.selenium.framework.jsoup.toolkit;
...
import com.ctm.selenium.framework.jsoup.webpages.SoupPage;
import com.ctm.selenium.framework.jsoup.webpages.SoupPageGroup;
import com.ctm.selenium.framework.utility.parallelism.Function;
import com.ctm.selenium.framework.utility.parallelism.Parallel;
...
public class ParallelWebTools {
	...
	public static SoupPageGroup parseResponses(List<Response> responses) throws RuntimeException {
		return new SoupPageGroup(parallel.apply(responses, new Function<Response, SoupPage>() {
			@Override public SoupPage apply(Response response) throws Exception {
