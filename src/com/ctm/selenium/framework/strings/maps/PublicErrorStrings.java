 ...
 * <br><br>
 * The PublicErrorStrings file contains Strings that are used in form filling error messages in ErrorManager when
 * a JUnit assert fails, this is especially used throughout JUnitTester.
 * 
 * @author Sean Seltzer
 *
 */
public enum PublicErrorStrings {
	...
	TEXT_BLANK,
	COUNT_MISMATCH,
	ELEMENT_ATTR_NOT_EXIST,
	ELEMENT_ATTR_MISMATCH,
	ELEMENT_ATTR_ILLEGAL,
	ELEMENT_VISIBLE,
	ELEMENT_NOT_VISIBLE,
	INVALID_VPREFID,
	INVALID_CONTENTZONE,
	JUNIT_TEST,
	ELEMENT_NOT_EXIST_AT_ELEMENT,
